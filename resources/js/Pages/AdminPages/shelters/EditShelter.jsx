...
export default function AddShelter({ auth, shelter }) {
  const { data, setData, post, errors } = useForm({
    nama: shelter.nama || "",
    provinsi: shelter.provinsi || "",
    kota: shelter.kota || "",
    alamat: shelter.alamat || "",
    nomor_wa: shelter.nomor_wa || "",
    khusus: shelter.khusus || "",
    deskripsi: shelter.deskripsi || "",
    foto: shelter.foto || "",
    _method: "PUT",
  });
  ...
  const submit = (e) => {
    ...
    post(route("shelter.update", shelter.id));
  };
    ...
    >
      <form onSubmit={submit} encType="multipart/form-data">
        ...
        <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
          ...
          <div className="sm:col-span-2">
            <InputLabel htmlFor="nomor_wa">Nomor WhatsApp</InputLabel>
            <div className="mt-2">
              <TextInput
                type="number"
                name="nomor_wa"
              ...
              />
              <InputError message={errors.nomor_wa} className="mt-2 text-red" />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2">
              <SelectOption
                nameId={"khusus"}
                value={data.khusus}
                onChange={(e) => setData("khusus", e.target.value)}
              >
                <option hidden value="">
                  Pilih Opsi
                </option>
              ...
              <InputError message={errors.khusus} className="mt-2 text-red" />
            </div>
          </div>
